...
require(__DIR__ . '/../includes/Wrench/lib/SplClassLoader.php');
$classLoader = new SplClassLoader('Wrench', __DIR__ . '/../includes/Wrench/lib');
$classLoader->register();

require(__DIR__ . '/../includes/chess.class.php');
require(__DIR__ . '/../includes/gameinstance.class.php');

$server = new \Wrench\Server('ws://0.0.0.0:8000/', array(
...
$server->registerApplication('chess', new \Wrench\Application\Chess());
$server->run();